...
bm25_retriever = None              # for keyword search
llm = None
...
def build_or_load_faiss(chunks, embeddings):
    ...
    if os.path.exists(VECTORSTORE_PATH):
        print("FAISS index found on disk.")
...
Use ONLY the provided context to answer the customer's question.

Rules:
- Keep the answer concise and professional
- Answer in customer-support style
...
def generate_answer(query):
    ...
    # Return both the answer and the source docs
    return {
        "answer": answer,
        "sources": [
